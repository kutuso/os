...
- **M2 (in flight):** `kutu-doctor` — the live memory-health dashboard and
  mode switcher — is [built and shipped](./DOCTOR.md); `kutu-memoryd`
...
- **M3:** `libmempressure` — a Linux answer to Android's onTrimMemory, so
  ...
  [built and tested](./LIBMEMPRESSURE.md); `mempressured` and app
  integration follow

Design spec: [superpowers/specs/2026-08-27-ramageddon-pivot-design.md](https://github.com/kutuso/os/blob/master/superpowers/specs/2026-08-27-ramageddon-pivot-design.md)
